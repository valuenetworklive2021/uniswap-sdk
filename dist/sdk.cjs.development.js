...
var IValueswapV2Pair = _interopDefault(require('@valueswap/v2-core/build/IValueswapV2Pair.json'));
...
var FACTORY_ADDRESS = '0xF8CC7061b9286b16dF5909BF7969b50209A551E1';
var INIT_CODE_HASH = '0xbd180ae29cf24eb2aeb0c652457a18bf292f7aaa4661545fb91e6eefcffe1a24';
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'VNTW-V2', 'Valueswap V2');
...
var ZERO_HEX = '0x0';
/**
 * Represents the Valueswap V2 Router, and has static methods for helping execute trades.
 */
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IValueswapV2Pair.abi, provider).getReserves()).then(function (_ref) {
